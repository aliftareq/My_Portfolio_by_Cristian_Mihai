...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+880) 1834-910647",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "alifhossen3721@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "Agrabad C/A, Chittagong, Bangladesh",
  },
];
          ...
          <div className="xl:w-[60%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                ...
                Accusamus similique iste totam placeat minus.
              </p>
              {/* input */}
